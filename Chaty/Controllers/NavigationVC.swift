...
//  Chaty
//
//  Created by Sam Griffiths on 15/06/2018.
...
class NavigationVC: UINavigationController, UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout, UIScrollViewDelegate {
